...
namespace Anfield.Controllers
{
    public class PatientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PatientId,FirstName,LastName,DateOfBirth,Gender,ContactNumber")] Patient patient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PatientId,FirstName,LastName,DateOfBirth,Gender,ContactNumber")] Patient patient)
        {
