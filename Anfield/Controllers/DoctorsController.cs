...
namespace Anfield.Controllers
{
    ...
    public class DoctorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DoctorId,Name,Surname,Age,ContactNumber,Address,Email")] Doctor doctor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DoctorId,Name,Surname,Age,ContactNumber,Address,Email")] Doctor doctor)
        {
