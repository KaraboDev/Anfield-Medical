...
namespace Anfield.Controllers
{
    ...
    public class AdminsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AdminId,Name,Surname,Age,ContactNumber,Address,Email")] Admin admin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AdminId,Name,Surname,Age,ContactNumber,Address,Email")] Admin admin)
        {
            if (id != admin.AdminId)
            {
                return NotFound();
