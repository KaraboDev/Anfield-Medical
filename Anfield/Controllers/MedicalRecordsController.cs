...
namespace Anfield.Controllers
{
    public class MedicalRecordsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MedicalRecordId,PatientId,VisitDate,Diagnosis,Prescription")] MedicalRecord medicalRecord)
        {
            ...
            ViewData["PatientId"] = new SelectList(_context.Patients, "PatientId", "ContactNumber", medicalRecord.PatientId);
            return View(medicalRecord);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MedicalRecordId,PatientId,VisitDate,Diagnosis,Prescription")] MedicalRecord medicalRecord)
        {
